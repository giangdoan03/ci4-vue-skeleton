            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarCharts">
                    <ul class="side-nav-second-level">
                        ...
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarEcharts" aria-expanded="false"
                               aria-controls="sidebarEcharts">
                                <span> Echart </span>
                                <span class="menu-arrow"></span>
                            </a>
                            <div class="collapse" id="sidebarEcharts">
                                <ul class="side-nav-third-level">
                                    <li>
                                        <a href="charts-echarts-line.html">Line</a>
                                    </li>
                                    <li>
                                        <a href="charts-echarts-bar.html">Bar</a>
                                    </li>
                                    <li>
                                        <a href="charts-echarts-candlestick.html">Candlestick</a>
                                    </li>
                                    <li>
                                        <a href="charts-echarts-geomap.html">Geo Map</a>
                                    </li>
                                    <li>
                                        <a href="charts-echarts-scatter.html">Scatter</a>
                                    </li>
                                    <li>
                                        <a href="charts-echarts-pie.html">Pie</a>
                                    </li>
                                    <li>
                                        <a href="charts-echarts-gauge.html">Gauge</a>
                                    </li>
                                    <li>
                                        <a href="charts-echarts-radar.html">Radar</a>
                                    </li>
                                    <li>
                                        <a href="charts-echarts-heatmap.html">Heatmap</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
